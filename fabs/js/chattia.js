(function(){
  const WORKER_CHAT_URL = 'https://recaptcha-botforms.gabrieloor-cv1.workers.dev/chat';
  const WORKER_END_SESSION_URL = 'https://recaptcha-botforms.gabrieloor-cv1.workers.dev/end-session';
  const WORKER_HONEYPOT_URL = 'https://recaptcha-botforms.gabrieloor-cv1.workers.dev/honeypot-trip';
